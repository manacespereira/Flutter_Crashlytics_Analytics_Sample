...
class AnalyticsPage extends StatefulWidget {
  ...
  AnalyticsPage({Key key, this.analytics, this.observer}) : super(key: key);
...
class _AnalyticsPageState extends State<AnalyticsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Firebase Analytics Sample'),
      ),
      body: Center(
        child: Column(
          children: <Widget>[
      ...
      floatingActionButton: FloatingActionButton(
          ...
          onPressed: () => Navigator.of(context).pushNamed(TabsPage.ROUTE)),
    );
  }
}
